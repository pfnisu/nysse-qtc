...
export function Settings(l) {
    ...
    this.load = async () => {
        ...
        this.tree.innerHTML =
            ...
            `<p>${l.str.api}: \u00a9 2026 <a href="https://digitransit.fi/en/developers/apis/7-terms-of-use/">Digitransit</a></p>` +
            `<h2>${l.str.license}</h2>` +
            '<p>Copyright \u00a9 2023-2026 Niko Suoniemi &lt;pfnisu@outlook.com&gt;</p>' +
